...
public class MaintenanceDTO {
    ...
    public MaintenanceDTO(String MID, String Vehicle_NO, String Maintenance_Company_Name, String Company_Address, String Contact_Number, String AddedOn, String NextDueDate, String PaymentStatus, double Amount) {
        this.MID = MID;
    ...
    public String toString() {
        return "MaintenanceDTO{" + "MID=" + MID + ", Vehicle_NO=" + Vehicle_NO + ", Maintenance_Company_Name=" + Maintenance_Company_Name + ", Company_Address=" + Company_Address + ", Contact_Number=" + Contact_Number + ", AddedOn=" + AddedOn + ", NextDueDate=" + NextDueDate + ", PaymentStatus=" + PaymentStatus + ", Amount=" + Amount + '}';
    }
