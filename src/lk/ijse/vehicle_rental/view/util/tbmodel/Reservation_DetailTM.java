 ...
 * @author zoomcoder
 */
public class Reservation_DetailTM {
    private String RID;
    ...
    public Reservation_DetailTM() {
    }

    public Reservation_DetailTM(String RID, String Vehicle_No, Date Resive_Date, Date Resive_Till_Date, Date Resive_Time, Date Resive_Till_Time) {
        this.RID = RID;
    ...
    public String toString() {
        return "Reservation_DetailTM{" + "RID=" + RID + ", Vehicle_No=" + Vehicle_No + ", Resive_Date=" + Resive_Date + ", Resive_Till_Date=" + Resive_Till_Date + ", Resive_Time=" + Resive_Time + ", Resive_Till_Time=" + Resive_Till_Time + '}';
    }
