...
public class PaymentTM {
    ...
    public PaymentTM(String Payment_ID, String Payment_Status, double Advance_Paid, double Total_Price) {
    ...
    public String toString() {
        return "PaymentTM{" + "Payment_ID=" + Payment_ID + ", Payment_Status=" + Payment_Status + ", Advance_Paid=" + Advance_Paid + ", Total_Price=" + Total_Price + '}';
    }
